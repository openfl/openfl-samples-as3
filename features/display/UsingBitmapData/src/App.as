package {
	...
	public class App extends Sprite {
		...
		public function App () {
			...
			var image:BitmapData = Assets.getBitmapData ("assets/openfl.png");
			...
			var bitmapData:BitmapData = image.clone ();
			...
			bitmapData = new BitmapData (image.width, image.height, true, 0xFFEEEEEE);
			...
			bitmapData = image.clone ();
			bitmapData.scroll (Math.round (image.width / 2), 0);
			bitmap = new Bitmap (bitmapData);
			bitmap.x = 240;
			bitmap.y = 140;
			addChild (bitmap);
